...
{
    jaeger_counter* counter = jaeger_global_alloc->malloc(
...
{
    jaeger_gauge* gauge =
        jaeger_global_alloc->malloc(jaeger_global_alloc, sizeof(default_gauge));
    if (gauge == NULL) {
...
{
    jaeger_gauge* gauge =
        jaeger_global_alloc->malloc(jaeger_global_alloc, sizeof(jaeger_gauge));
    if (gauge == NULL) {
